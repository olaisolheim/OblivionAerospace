...
* Currently featuring the *Conical Heat Shield* inspired by the sphere-cone heat shield on the Mars Science Laboratory.
  ...
  * Comes with an auto-shroud for its bottom node meeting flush with the shield. It works like an engine shroud. Just add something to the heat shield's bottom node and the shroud/adapter will appear!
